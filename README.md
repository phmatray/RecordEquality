> [!IMPORTANT]
> **This repository has moved.** The code now lives in **[phmatray/dotnet-toolbelt](https://github.com/phmatray/dotnet-toolbelt)** under [`src/record-equality`](https://github.com/phmatray/dotnet-toolbelt/tree/main/src/record-equality) — full git history preserved. This repository is archived (read-only). The NuGet package ID is unchanged.
